...
DOCKER_COMPOSE_FILE="uat-docker-compose.yml"  # Name of your Docker Compose file
...
if [ $? -ne 0 ]; then
    echo "Bringing up uat-docker-compose.yml failed." >&2
    exit 1
fi

echo "uat-docker-compose.yml deployed successfully."
